...
async def about(interaction: discord.Interaction):
    ...
    embed.add_field(
        name="LumoraNodes",
        value=(
            "**LumoraNodes is affordable and reliable hosting solution** in India 🇮🇳\n\n"
            "🔹 **What we Provides:**\n"
    ...
    # Social Links
    embed.add_field(
        name="🔗 Connect with LumoraNodes",
        value=(
            "📺 **YouTube:** [Watch Tutorials & Guides](https://www.youtube.com/@lumoranodes)\n"
            "💻 **GitHub:** [View Projects & Scripts](https://github.com/lumoranodes)\n"
            "📸 **Instagram:** [Follow for Updates](https://instagram.com/lumoranodes)"
        ),
        inline=False
    )

    embed.set_footer
    text="Built with ❤️ and ☕ by LumoraNodes Team | Thank you for using LumoraVPS Bot!",
    embed.set_thumbnail(
